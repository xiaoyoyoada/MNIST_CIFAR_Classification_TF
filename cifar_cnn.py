...
def main():
    ...
    with tf.Graph().as_default(), tf.Session() as sess:
        ...
        with tf.name_scope("conv_layer_2"):
            ...
            conv2 = tf.layers.dropout(conv2, rate=cnn_drop_rate, training=is_train)
            # l2 regularizer
        ...
        with tf.name_scope("conv_layer_4"):
            ...
            conv4 = tf.layers.dropout(conv4, rate=cnn_drop_rate, training=is_train)
            # l2 regularizer
        ...
        with tf.name_scope("conv_layer_6"):
            ...
            conv6 = tf.layers.dropout(conv6, rate=cnn_drop_rate, training=is_train)
            # l2 regularizer
        ...
        with tf.name_scope("conv_layer_8"):
            ...
            conv8 = tf.layers.dropout(conv8, rate=cnn_drop_rate, training=is_train)
            # l2 regularizer
        ...
        with tf.name_scope("fc_layer_1"):
            ...
            fc1 = tf.layers.dropout(fc1, rate=ffn_drop_rate, training=is_train)
            # l2 regularizer
